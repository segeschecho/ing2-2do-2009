...
Si bien no se agregaron nuevas componentes al sistema de monitoreo, se quitaron algunas, como por ejemplo los web services a la página de la infraestructura en las ECP, los de las otras empresas podrían estar o no de acuerdo a los criterios de la provincia, y lo mismo con el sistema eólico, por eso preferimos mostrar en las imágenes posteriores el sistema de monitoreo de la primera entrega ya que la forma depende propiamente de cada una de las provincias.
\subsection{TR}
